    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          <img src={process.env.PUBLIC_URL+image} alt="plant" className='animate-bounce p-2' />
          {isSelected?
          <h2 className='font-jar text-[#116B53] text-xl font-jaro text-center'>{name}</h2>
          :
          <h2 className='font-jar text-[#EED3B1] text-xl font-jaro text-center'>{name}</h2>
          }
        </div>
